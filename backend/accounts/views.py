...
from .helpers import BaseEmailConfirmAPIView, BaseUserUpdateProfileMixin
...
class UploadProfileImageAPIView(BaseUserUpdateProfileMixin):
    """
...
class UploadProfileAboutAPIView(BaseUserUpdateProfileMixin):
    """
